...
<body>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-evolucao1.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Adicionar Evolução</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								<?php
                                    ...
                                    if($evolucao->getDados() != "0")
                                    {
                                        echo $evolucao->getDados();
                                    }
                                    else
                                    {
                                        echo "<script>var resulEvolucao = 0;</script>";
                                    }
                                ?>
							</table>
						</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<h3>Tem certeza de que deseja excluir está evolução?</h3>
    ...
    <script>
        ...
        if(resulEvolucao == 0)
        {
            window.location.href = "add-evolucao1.php";
        }
        
        $(document).on('click','.delete',function(){
            $idEVOLUCAO     = $(this).closest('tr').find('td').eq(getColumnValue("idEVOLUCAO")).text();
